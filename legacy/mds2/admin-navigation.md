...
- **Extensions**
  ...
  Extensions register their menu items via the `mds_register_dashboard_menu` action and `Menu_Registry` API. For developers building extensions, see [Extension Development](/docs/mds-2/million-dollar-script/2.6/main/extension-development). Example:
  ```php
