...
**Note:** If you encounter any errors during installation, see the [Troubleshooting Guide](/docs/mds-2/million-dollar-script/2.6/main/troubleshooting#installation-issues).
...
Having issues with installation, updates, or configuration? See the comprehensive [Troubleshooting Guide](/docs/mds-2/million-dollar-script/2.6/main/troubleshooting) which covers:

- [Installation Issues](/docs/mds-2/million-dollar-script/2.6/main/troubleshooting#installation-issues) - Upload limits, activation errors, permissions
- [Plugin Updates](/docs/mds-2/million-dollar-script/2.6/main/troubleshooting#plugin-updates) - Download failures, update errors
- [Routes & 404s](/docs/mds-2/million-dollar-script/2.6/main/troubleshooting#routes--404-errors) - Permalink issues
- [Grid Alignment](/docs/mds-2/million-dollar-script/2.6/main/troubleshooting#grid-alignment) - Selection boxes not matching grid
...
- If block selections don't align with the image, see [Troubleshooting: Grid Alignment](/docs/mds-2/million-dollar-script/2.6/main/troubleshooting#grid-alignment).
