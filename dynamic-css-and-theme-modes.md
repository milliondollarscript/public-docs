...
- In Million Dollar Script 3, **Settings > General > Theme Mode** applies to admin screens and frontend Million Dollar Script grid/page embeds. Light and Dark force that mode; System follows `prefers-color-scheme`.
